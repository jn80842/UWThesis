...
\jln{More general intro para needed here. possibly rewrite para below to be generally about reasoning in compilers, then 2nd para specifically about reasoning in Halide.}
